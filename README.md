...
> Answer: Client side routing allows for the pages of an application to refresh without having to send another request to the server. It allows for faster loading of pages and does not bog the site down. 
